...
public class MyGame extends JFrame {
	...
	public static void main(String[] args) throws IOException {
		game = new MyGame();
		game.showController(MyGame.HOMEPAGE);
	}
	...
	public void showController(int mode) throws IOException {
		if (controller == null) {
...
class Game512 extends JPanel {
	...
	void gameOver(GameBoard512 gb, boolean lose) throws IOException {
	...
	private class GameBoard512 extends GameBoard {
...
class GameBoard extends JPanel implements KeyListener {
	...
	void winGame() {
		try{
			MyGame.game.showController(MyGame.WINGAME);
		} catch (Exception ex) {
			System.out.println("ERROR");
		}
	}
	...
	void endGame() {
		try{
			MyGame.game.showController(MyGame.GAMEOVER);
		} catch (Exception ex) {
			System.out.println("ERROR");
		}
	}
